...
public class Boot {
    ...
    public static void main(String... args) throws Exception {
        ...
        if (!Config.PROJECT_TYPE.equalsIgnoreCase("maven") && !Config.PROJECT_TYPE.equalsIgnoreCase("gradle")) {
            System.out.println("PROJECT_TYPE has to be: maven OR gradle!");
            System.exit(0);
        ...
        isMaven = Config.PROJECT_TYPE.equalsIgnoreCase("maven");
